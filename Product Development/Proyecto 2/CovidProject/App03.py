...
def getdata():
    WORLD_CONFIRMED_URL = 'https://raw.githubusercontent.com/Marcot98/MaestriaDataScience/main/Product%20Development/Proyecto%202/time_series_covid19_confirmed_global.csv'
    WORLD_DEATHS_URL = 'https://raw.githubusercontent.com/Marcot98/MaestriaDataScience/main/Product%20Development/Proyecto%202/time_series_covid19_deaths_global.csv'
    WORLD_RECOVERED_URL = 'https://raw.githubusercontent.com/Marcot98/MaestriaDataScience/main/Product%20Development/Proyecto%202/time_series_covid19_recovered_global.csv'
...
def drop_neg(df):
    ...
    idx_l = df[df.iloc[:, -1].astype(int) < 0].index.tolist()
    for i in idx_l:
...
def footer():
    ...
    st.markdown(
        'Usamos data de casos de COVID19')
